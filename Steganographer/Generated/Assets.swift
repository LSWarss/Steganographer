...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let defaultFontColor = ColorAsset(name: "defaultFontColor")
    internal static let defaultFontColorReversed = ColorAsset(name: "defaultFontColorReversed")
    internal static let defaultGrey = ColorAsset(name: "defaultGrey")
